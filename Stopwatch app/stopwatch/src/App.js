...
function Record({ title, lap, extraStyles }) {
  console.log(title, lap);
  return (
    <View style={[styles.lap, extraStyles]}>
...
function RecordsTableFlatList({ records }) {
...
export default class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      laps: [],
      records: [
        { title: "first lap", lap: 720 },
        { title: "second lap", lap: 7893 },
      ],
      searchedRecords: [],
      isTimerActive: false,
          ...
          {isTimerActive ? (
            ...
            <SafeAreaView style={{ width: "100%" }}>
              <View style={{ width: "100%", height: 40,
                    ...
                    borderRadius: 5,
                    borderColor: "#eee" }}>
                  {/* will contain the search bar here */}
                {/* <Icon /> */}
                <TextInput
              ...
              <SafeAreaView>
                  <RecordsTableFlatList records={this.state.searchRecordTerm
                    ? this.state.searchedRecords : this.state.records} />
              </SafeAreaView>
            </SafeAreaView>
          )}
        </View>
