		...
		interaction.editReply({
			...
			collector.on("collect", i => {
				i.deferReply().then(() => {
					...
					.addFields({
						name: "Parts",
						value: `${config.EMOTES.uncommon_part} x${Humanize.intComma(uncommons_total)}
${config.EMOTES.rare_part} x${Humanize.intComma(rares_total)}
${config.EMOTES.epic_part} x${Humanize.intComma(epics_total)}`
					})
					.addFields({
						name: "Upgrades",
						value: `${config.EMOTES.uncommon_part}${config.EMOTES.rare_part}${config.EMOTES.epic_part} ${Humanize.intComma(parts_total)} ${config.EMOTES.credit}
